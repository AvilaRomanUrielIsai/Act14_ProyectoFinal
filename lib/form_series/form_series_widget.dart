...
import 'form_series_model.dart';
export 'form_series_model.dart';

class FormSeriesWidget extends StatefulWidget {
  const FormSeriesWidget({Key? key}) : super(key: key);

  @override
  _FormSeriesWidgetState createState() => _FormSeriesWidgetState();
}

class _FormSeriesWidgetState extends State<FormSeriesWidget> {
  late FormSeriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormSeriesModel());
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Año',
                          hintText: 'Ingresa los años activa',
                          hintStyle: FlutterFlowTheme.of(context).bodySmall,
                          enabledBorder: UnderlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).warning,
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Ingresa la cantidad de temporadas',
                          hintStyle: FlutterFlowTheme.of(context).bodySmall,
                          enabledBorder: UnderlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).warning,
